...
const showcaseImages = Array.from({ length: 24 }, (_, i) => ({
      ...
      <section id="showcase" className="py-20 bg-muted/40 overflow-hidden">
        <div className="container mx-auto">
          ...
          <div ref={showcaseRef} className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 relative z-10 max-h-[80vh] overflow-y-auto">
